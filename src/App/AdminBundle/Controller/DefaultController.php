...
class DefaultController extends Controller
{
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/start-server.bash");
        if($messages == null){
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/stop-server.bash");
        if($messages == null){
            $messages = "La commande ne fonctionne pas.";
        }
        return $this->redirectToRoute('server', array(
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/reload-server.bash");
        if($messages == null){
            $messages = "La commande ne fonctionne pas.";
        }
        return $this->redirectToRoute('server', array(
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/show-process.bash");
        if($messages == null){
            $messages = "La commande ne fonctionne pas.";
        }
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/surveillance-statistique.bash");
        if($messages == null){
            $messages = "La commande ne fonctionne pas.";
        }
        return $this->render('@AppAdmin/Default/showprocess.html.twig', array(
    ...
    {
        $messages = shell_exec("/var/www/html/scripts/surveillance-diagnostic.bash");
        if($messages == null){
            $messages = "La commande ne fonctionne pas.";
        }
        return $this->render('@AppAdmin/Default/showprocess.html.twig', array(
